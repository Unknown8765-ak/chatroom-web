...
function MessageRoom() {
  ...
  // );
  return (
  <div className="min-h-[100dvh] flex flex-col bg-linear-to-br from-indigo-600 via-purple-600 to-pink-500">

    {/* HEADER */}
    <div className="backdrop-blur-xl bg-white/10 border-b border-white/20 text-white shadow-lg">
      <div className="max-w-6xl mx-auto px-4 py-4 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <div className="flex flex-wrap gap-2">
          <button
            onClick={getActiveUsers}
            className="bg-blue-500 hover:bg-blue-600 px-3 py-2 rounded-lg text-xs sm:text-sm"
          >
            Active Users
          </button>
          ...
          <button
            onClick={leaveRoom}
            className="bg-yellow-500 hover:bg-yellow-600 px-3 py-2 rounded-lg text-xs sm:text-sm"
          >
            Leave
          </button>
          ...
          {currentUser?._id === roomCreator && (
            <button
              onClick={deleteRoom}
              className="bg-red-500 hover:bg-red-600 px-3 py-2 rounded-lg text-xs sm:text-sm"
            >
              Delete
            </button>
          )}
    ...
    {showUsers && (
      <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50 px-4">
        <div className="bg-white text-black rounded-xl shadow-2xl w-full max-w-sm p-4">
    ...
    {/* MESSAGES */}
    <div className="flex-1 overflow-y-auto px-3 sm:px-6 py-4 space-y-3 max-w-5xl w-full mx-auto">
      ...
      {messages.map((msg, index) => {
        ...
        return (
          ...
          >
            <div
              className={`max-w-[80%] sm:max-w-sm px-4 py-3 rounded-2xl text-sm shadow-lg break-words
              ${
                isMe
                  ? "bg-white text-purple-700 rounded-br-none"
                  : "bg-white/20 backdrop-blur-md text-white rounded-bl-none"
    ...
    {/* INPUT */}
    <div className="sticky bottom-0 backdrop-blur-xl bg-white/10 border-t border-white/20 p-3">
      <div className="max-w-5xl mx-auto flex gap-2">
        ...
        <button
          onClick={sendMessage}
          className="bg-white text-purple-700 px-4 sm:px-6 rounded-full font-semibold hover:bg-purple-100"
        >
          Send
        </button>
